...
ApplePie.ingredients = Array.prototype.slice.call(document.querySelectorAll('#ingredient-list > ul > li')).map(function(element) {
...
// TODO:
document.querySelector('img.pie').addEventListener('click', function() {
	console.log('Apple-pie clicked');
});
