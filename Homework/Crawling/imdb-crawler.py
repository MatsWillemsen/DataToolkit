...
def scrape_movie_page(dom):
    ...
    duration = dom('.infobar > time')[0].content.strip().replace(' min','')
    genres = ";".join([x.content for x in dom('.infobar > a > span')])
    directors = ";".join([x.content for x in dom('#overview-top .txt-block[itemprop="director"] > a > span')])
    writers = ";".join([x.content for x in dom('#overview-top .txt-block[itemprop="creator"] > a > span')])
    actors = ";".join([x.content for x in dom('#overview-top .txt-block[itemprop="actors"] > a > span')])
